        ...
        <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            {navItems.map((item) => (
              ...
              className="relative">
                <motion.span
                className={`font-medium transition-colors durtion-300
                ${
          ...
          {isMenuOpen && (
            ...
            ${darkMode
              ? 'bg-gray-900/95'
              : 'bg-white/95'
            } backgrop-blur-lg rounded-xl shadow-log border ${
              ...
              <div className="px-4 py-3 space-y-2">
                ...
                whileTap={{ scale: 0.95 }}
                className={`block py-3 px-4 text-center font-semi-bold rounded-lg bg-linear-to-r ${colors.button} text-white shadow-md`}>
                  Hire Me
                </motion.a>
              </div>
            </motion.div>
